                        ...
                        if(Menu.Name === props.CurrentContent){
                            ...
                            return(
                                <tr className="LeftMenuTableOnMouseOver" key={Menu.id} onClick={() => props.SetCurrentContent(Menu.Name)}>
                                    <td className="LeftMenuTableImage"><img className="LeftMenuTableIcon" src={props.Theme==="dark" ? Menu.Image.Dark : Menu.Image.Light} alt={Menu.Name}/></td>
                                    <td className="LeftMenuTableText" ><TextStyled>{Menu.Name}</TextStyled></td>
                                    <td className="LeftMenuTableImageAdditional"><PlusButton Name={Menu.Name} Theme={props.Theme}/></td>
